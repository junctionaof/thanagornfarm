...
?>
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-table"></i>รายการ บันทึกค่่า PH 
            </div>
            <div class="tools">
            ...
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="portlet-title">
                                <div class="actions">
                                 	<a class="btn add" href="<?= Url::toRoute(['pond/editph'])?>" title="เพิ่ม">
                                        <i class="icon-plus"> บันทึก บันทึกค่่า PH </i>
                                    </a>
                                </div>
                        </div>
                    </div>
