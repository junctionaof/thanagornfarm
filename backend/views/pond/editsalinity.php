...
if($model->salinityTime == ''){
	$correntDate =  date( "Y-m-d H:i:s",strtotime("now"));
}else {
	$correntDate = $model->salinityTime;
}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i><?php echo $status; ?>ค่าความเค็มของนํ้า </div>
                                    <div class="tools">
                                             ...
                                             <div class="form-group">
                                                <label class="control-label col-md-3">วันที่วัด</label>
                                                      <div class="input-group input-large" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                                       <?= Html::input('text', 'salinityTime' ,$correntDate ,['id'=>'salinityTime','class' => 'form-control']);?>
                                                  	</div>
                                            </div>
                                             <div class="form-group">
                                                <label class="control-label col-md-3">ค่าที่วัดได้</label>
                                                      <div class="input-group input-large " >
                                                       <?= Html::input('text', 'salinityNum', $model->salinityNum,['id'=>'salinityNum','class' => 'form-control']);?>
                                                  	<span class="input-group-addon">
                                                        <i class="fa"> salinity</i>
                                                    </span>
                                                  	</div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    ...
                                                    <a href="<?php echo Url::toRoute('pond/salinity') ?>" class="btn default" >ยกเลิก </a>
                                                </div>
                                            </div>
                                        </div>
