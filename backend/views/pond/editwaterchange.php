...
if($model->waterchangeTime == ''){
	$correntDate =  date( "Y-m-d H:i:s",strtotime("now"));
}else {
	$correntDate = $model->waterchangeTime;
}

$contentDate = "";
$contentTime = "";
$arrchang = ['1'=>'เปลี่ยนเข้า','2'=>'ถ่ายออก'];
$str = <<<EOT
                                        ...
                                        <div class="form-body">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label class="control-label col-md-3">วันที่เปลี่ยน</label>
                                                      <div class="input-group input-large" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                                       <?= Html::input('text', 'waterchangeTime' ,$correntDate ,['id'=>'waterchangeTime','class' => 'form-control']);?>
                                                  	</div>
                                            </div>
                                             <div class="form-group">
                                                <label class="control-label col-md-3">เปลี่ยน</label>
                                                      <div class="input-group input-large " >
                                                       <?php echo Html::dropDownList('pondId', ' ', $arrchang , ['id'=>'pondId','class' => 'select2 form-control'])?>	
                                                  	<span class="input-group-addon">
                                                        <i class="fa"> waterchange</i>
                                                    </span>
                                                  	</div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    ...
                                                    <a href="<?php echo Url::toRoute('pond/waterchange') ?>" class="btn default" >ยกเลิก </a>
                                                </div>
                                            </div>
                                        </div>
