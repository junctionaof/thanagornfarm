...
if($model->alkalinityTime == ''){
	$correntDate =  date( "Y-m-d H:i:s",strtotime("now"));
}else {
	$correntDate = $model->alkalinityTime;
}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i> บันทึกค่าอัลคาไลน์นิติ </div>
                                    <div class="tools">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label class="control-label col-md-3">วันที่ให้อาหาร</label>
                                                      <div class="input-group input-large" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                                       <?= Html::input('text', 'alkalinityTime' ,$correntDate ,['id'=>'alkalinityTime','class' => 'form-control']);?>
                                                  	</div>
                                            </div>
                                               <div class="form-group">
                                                <label class="control-label col-md-3">มื้อที่</label>
                                                      <div class="input-group input-large ">
                                                        <?= Html::input('text', 'alkalinityNo', $model->age,['id'=>'alkalinityNo','class' => 'form-control']);?>
                                                  	</div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                <label class="control-label col-md-3">เบอร์อาหาร</label>
                                                      <div class="input-group input-large " >
                                                       <?= Html::input('text', 'alkalinityNum', $model->alkalinityNum,['id'=>'alkalinityNum','class' => 'form-control']);?>
                                                  	</div>
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    ...
                                                    <a href="<?php echo Url::toRoute('pond/alkalinity') ?>" class="btn default" >ยกเลิก </a>
                                                </div>
                                            </div>
                                        </div>
