...
?>
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-table"></i>รายการ บันทึกค่าไนไตรท์
            </div>
            <div class="tools">
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="portlet-title">
                                <div class="actions">
                                 	<a class="btn add" href="<?= Url::toRoute(['pond/editnitrite'])?>" title="เพิ่ม">
                                        <i class="icon-plus"> บันทึกค่าไนไตรท์</i>
                                    </a>
                                </div>
                        </div>
                    </div>
			...
			<div class="row" ">
				<div class="col-md-12">
					...
					<?php echo Html::dropDownList('type', '0', ['0'=>"เลือกบ่อที่ต้องการ"]+$arrTypelist , ['id'=>'type','class' => 'form-control input-medium'])?>	
