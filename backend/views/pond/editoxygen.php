                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i> <?php echo $status; ?>ค่าออกซิเจนละลายนํ้า </div>
                                    <div class="tools">
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    ...
                                                    <a href="<?php echo Url::toRoute('pond/oxygen') ?>" class="btn default" >ยกเลิก </a>
                                                </div>
                                            </div>
                                        </div>
