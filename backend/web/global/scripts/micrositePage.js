(function($) {
	...
	function alert(text,status){
		...
		$( document ).ready(function() {
			...
			$.ajax({
			     ...
			     data : {
			    	 ...
			    	 feed:$('#selectFeed').attr('data-feedId')
			     },
				    		 ...
				    		 $.each(value ,function(index , data){
				    			 ...
				    			 if(index == 0){
									...
									$('#tb-'+key+' tr[data-content-id="0"]').css('display','none');
				    				 ...
				    				 //var thisValue = $('#tb-'+key+' tr:first').clone().removeAttr('style').removeClass('trClone').appendTo('#tb-'+key+''); 
				    			// newItems(thisValue,data);
				    		 });
			...
			$.ajax({
			     dataType: 'json',
			     type: 'GET',
			     url: 'micrositesetting',
			     data : {
			    	 section:'micrositeSetting',
			    	 _csrf:$('meta[name="csrf-token"]').attr("content"),
			    	 feed:$('#selectFeed').attr('data-feedId')
			     },
			     success: function(data) {
        ...
        $(document).delegate('#editContent','click',function(){
        	...
        	//$('#tablist').find('a [data-tabtype="'+$(this).data('type')+'"]').css('display','block');
        ...
        $( ".sortable2" ).sortable({
         ...
         $(document).delegate('#saveContent','click',function(){
        	...
        	var feedId = $('#selectFeed').attr('data-feedId');
